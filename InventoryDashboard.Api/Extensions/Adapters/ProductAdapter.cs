namespace InventoryDashboard.Api.Extensions.Adapters
{
    ...
    public static class ProductAdapter
    {
        ...
        public static UpdateProductWebResponseV2 ToWebResponseWithTax(this Response<UpdateProductResponse> legacy, ITaxService taxService)
        {
            if (legacy == null)
            {
                return new UpdateProductWebResponseV2(null, string.Empty, string.Empty);
            }
